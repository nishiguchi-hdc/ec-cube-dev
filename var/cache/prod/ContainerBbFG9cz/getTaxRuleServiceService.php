 ...
 */
class getTaxRuleServiceService extends Eccube_KernelProdDebugContainer
{
    /**
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['Eccube\\Service\\TaxRuleService'] = $container->createProxy('TaxRuleServiceGhostA63b08e', static fn () => \TaxRuleServiceGhostA63b08e::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
