 ...
 */
class getEccube_LoggerService extends Eccube_KernelProdDebugContainer
{
    /**
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['eccube.logger'] = $container->createProxy('LoggerGhostD068bc1', static fn () => \LoggerGhostD068bc1::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
