 ...
 */
class Eccube_KernelProdDebugContainer extends Container
{
    protected $targetDir;
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['Eccube\\Service\\SystemService'] = $container->createProxy('SystemServiceGhost85e20a8', static fn () => \SystemServiceGhost85e20a8::createLazyGhost(static fn ($proxy) => self::getSystemServiceService($container, $proxy)));
        }
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['doctrine.orm.default_entity_manager'] = $container->createProxy('EntityManagerGhostEf52108', static fn () => \EntityManagerGhostEf52108::createLazyGhost(static fn ($proxy) => self::getDoctrine_Orm_DefaultEntityManagerService($container, $proxy)));
        }
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'orm'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Cache'.\DIRECTORY_SEPARATOR.'Logging'.\DIRECTORY_SEPARATOR.'CacheLogger.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'orm'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Cache'.\DIRECTORY_SEPARATOR.'Logging'.\DIRECTORY_SEPARATOR.'CacheLoggerChain.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'orm'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Cache'.\DIRECTORY_SEPARATOR.'Logging'.\DIRECTORY_SEPARATOR.'StatisticsCacheLogger.php';
        ...
        $e = \Doctrine\Common\Cache\Psr6\CacheAdapter::wrap(\Doctrine\Common\Cache\Psr6\DoctrineProvider::wrap(($container->privates['doctrine.app_cache_pool'] ?? self::getDoctrine_AppCachePoolService($container))));
        ...
        $g = new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Eccube'.\DIRECTORY_SEPARATOR.'Entity'), (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'league'.\DIRECTORY_SEPARATOR.'oauth2-server-bundle'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity')], false);
        $h = ($container->privates['annotations.cached_reader'] ?? $container->load('getAnnotations_CachedReaderService'));

        $i = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [(\dirname(__DIR__, 4).'/src/Eccube/Entity')]);
        $i->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $j = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [(\dirname(__DIR__, 4).'/app/Plugin/AmazonPayV2_42_Bundle/Entity')]);
        $j->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $k = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [(\dirname(__DIR__, 4).'/app/Plugin/Api42/Entity')]);
        $k->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $l = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [(\dirname(__DIR__, 4).'/app/Plugin/B2BConnector/Entity')]);
        $l->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $m = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [(\dirname(__DIR__, 4).'/app/Plugin/Coupon42/Entity')]);
        $m->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $n = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [(\dirname(__DIR__, 4).'/app/Plugin/EccubePaymentLite42/Entity')]);
        $n->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $o = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [(\dirname(__DIR__, 4).'/app/Plugin/MailMagazine42/Entity')]);
        $o->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $p = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [(\dirname(__DIR__, 4).'/app/Plugin/ProductReview42/Entity')]);
        $p->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $q = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [(\dirname(__DIR__, 4).'/app/Plugin/Recommend42/Entity')]);
        $q->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $r = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [(\dirname(__DIR__, 4).'/app/Plugin/RelatedProduct42/Entity')]);
        $r->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $s = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [(\dirname(__DIR__, 4).'/app/Plugin/Securitychecker42/Entity')]);
        $s->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $t = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [(\dirname(__DIR__, 4).'/app/Plugin/SiteKit42/Entity')]);
        ...
        $f->addDriver(new \League\Bundle\OAuth2ServerBundle\Persistence\Mapping\Driver('League\\Bundle\\OAuth2ServerBundle\\Model\\Client', true, 'oauth2_'), 'League\\Bundle\\OAuth2ServerBundle\\Model');
        $f->addDriver($i, 'Eccube\\Entity');
        $f->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [(\dirname(__DIR__, 4).'/app/Customize/Entity')], false), 'Customize\\Entity');
        $f->addDriver($j, 'Plugin\\AmazonPayV2_42_Bundle\\Entity');
        $f->addDriver($k, 'Plugin\\Api42\\Entity');
        $f->addDriver($l, 'Plugin\\B2BConnector\\Entity');
        $f->addDriver($m, 'Plugin\\Coupon42\\Entity');
        $f->addDriver($n, 'Plugin\\EccubePaymentLite42\\Entity');
        $f->addDriver($o, 'Plugin\\MailMagazine42\\Entity');
        $f->addDriver($p, 'Plugin\\ProductReview42\\Entity');
        $f->addDriver($q, 'Plugin\\Recommend42\\Entity');
        $f->addDriver($r, 'Plugin\\RelatedProduct42\\Entity');
        $f->addDriver($s, 'Plugin\\Securitychecker42\\Entity');
        $f->addDriver($t, 'Plugin\\SiteKit42\\Entity');
        ...
        $a->setQueryCache($e);
        $a->setResultCache($e);
        $a->setMetadataDriverImpl(new \Doctrine\Bundle\DoctrineBundle\Mapping\MappingDriver($f, new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['Eccube\\Repository\\TaxRuleRepository'] = $container->createProxy('TaxRuleRepositoryGhost584de3b', static fn () => \TaxRuleRepositoryGhost584de3b::createLazyGhost(static fn ($proxy) => self::getTaxRuleRepositoryService($container, $proxy)));
        }
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['Eccube\\Service\\CartService'] = $container->createProxy('CartServiceGhostB5cf4b4', static fn () => \CartServiceGhostB5cf4b4::createLazyGhost(static fn ($proxy) => self::getCartServiceService($container, $proxy)));
        }
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['argument_resolver.request_payload'] = $container->createProxy('RequestPayloadValueResolverGhost1d2362c', static fn () => \RequestPayloadValueResolverGhost1d2362c::createLazyGhost(static fn ($proxy) => self::getArgumentResolver_RequestPayloadService($container, $proxy)));
        }
    ...
    {
        $container->privates['doctrine.app_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('SuvUs69B5f', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    protected static function getSecurity_Firewall_MapService($container)
    {
        ...
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.admin' => ($container->privates['.security.request_matcher.GUl1G7t'] ?? $container->load('get_Security_RequestMatcher_GUl1G7tService'));
    ...
    protected static function getTwigService($container)
    {
        ...
        $g->addWorkflow(($container->privates['debug.state_machine.order'] ?? self::getDebug_StateMachine_OrderService($container)), new \Symfony\Component\Workflow\SupportStrategy\InstanceOfSupportStrategy('Eccube\\Service\\OrderStateMachineContext'));
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Eccube_KernelProdDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Eccube_KernelProdDebugContainer',
