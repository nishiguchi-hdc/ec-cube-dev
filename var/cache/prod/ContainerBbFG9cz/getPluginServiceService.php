 ...
 */
class getPluginServiceService extends Eccube_KernelProdDebugContainer
{
    /**
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['Eccube\\Service\\PluginService'] = $container->createProxy('PluginServiceGhost4539875', static fn () => \PluginServiceGhost4539875::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
