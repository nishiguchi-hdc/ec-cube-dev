...
class __TwigTemplate_6e29c23bc463218435a3f5a398ddd977 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "Mail/entry_confirm.html.twig"));
...
<table border=\"0\" width=\"100%\" height=\"100%\" cellpadding=\"0\" cellspacing=\"0\" bgcolor=\"#F0F0F0\" style=\"border-spacing:0;mso-table-lspace:0pt;mso-table-rspace:0pt;\">
    <tr>
        ...
        echo "でございます。<br/>
                            ...
                            <a href=\"";
        // line 36
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["activateUrl"]) || array_key_exists("activateUrl", $context) ? $context["activateUrl"] : (function () { throw new RuntimeError('Variable "activateUrl" does not exist.', 36, $this->source); })()), 36, $this->source), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["activateUrl"]) || array_key_exists("activateUrl", $context) ? $context["activateUrl"] : (function () { throw new RuntimeError('Variable "activateUrl" does not exist.', 36, $this->source); })()), 36, $this->source), "html", null, true);
        echo "</a>
                            <br/>
            ...
            <table id=\"html-mail-table2\" border=\"0\" width=\"600px\" cellpadding=\"10\" cellspacing=\"0\" class=\"container\" style=\"border-spacing:0;mso-table-lspace:0pt;mso-table-rspace:0pt;\">
                <tr>
                    <td class=\"container-padding content footer-text\" align=\"left\" style=\"border-collapse:collapse;font-family:Helvetica, Arial, sans-serif;font-size:12px;line-height:16px;color:#aaaaaa;padding-left:24px;padding-right:24px;padding-top:12px;padding-bottom:12px;background-color:#ffffff;\">
                        本メールは、";
        // line 52
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["BaseInfo"]) || array_key_exists("BaseInfo", $context) ? $context["BaseInfo"] : (function () { throw new RuntimeError('Variable "BaseInfo" does not exist.', 52, $this->source); })()), "shop_name", [], "any", false, false, true, 52), 52, $this->source), "html", null, true);
        echo "より会員登録を希望された方にお送りしています。<br/>
                        もしお心当たりが無い場合は、その旨 <a href=\"mailto:";
        // line 53
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["BaseInfo"]) || array_key_exists("BaseInfo", $context) ? $context["BaseInfo"] : (function () { throw new RuntimeError('Variable "BaseInfo" does not exist.', 53, $this->source); })()), "email02", [], "any", false, false, true, 53), 53, $this->source), "html", null, true);
        ...
        echo "</a></div>
                        <div>copyright &copy; ";
        // line 56
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["BaseInfo"]) || array_key_exists("BaseInfo", $context) ? $context["BaseInfo"] : (function () { throw new RuntimeError('Variable "BaseInfo" does not exist.', 56, $this->source); })()), "shop_name", [], "any", false, false, true, 56), 56, $this->source), "html", null, true);
...
";
    ...
    {
        return array (  135 => 56,  129 => 55,  122 => 53,  118 => 52,  97 => 36,  91 => 33,  84 => 31,  65 => 17,  57 => 11,);
    }
...
", "Mail/entry_confirm.html.twig", "C:\\xampp\\htdocs\\ec-cube-dev\\src\\Eccube\\Resource\\template\\default\\Mail\\entry_confirm.html.twig");
    }
