...
/* EccubePaymentLite42/Resource/template/default/Mail/expiration_notice_mail.html.twig */
class __TwigTemplate_51f40ae70d05345a870895e1c5e27afd extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "EccubePaymentLite42/Resource/template/default/Mail/expiration_notice_mail.html.twig"));
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "EccubePaymentLite42/Resource/template/default/Mail/expiration_notice_mail.html.twig"));
...
<table border=\"0\" width=\"100%\" height=\"100%\" cellpadding=\"0\" cellspacing=\"0\" bgcolor=\"#F0F0F0\" style=\"border-spacing:0;mso-table-lspace:0pt;mso-table-rspace:0pt;\">
    <tr>
            ...
            <table id=\"html-mail-table1\" border=\"0\" width=\"600px\" cellpadding=\"10\" cellspacing=\"0\" class=\"container\" style=\"border-spacing:0;mso-table-lspace:0pt;mso-table-rspace:0pt;\">
                <tr>
                    <td class=\"container-padding content\" align=\"left\" style=\"border-collapse:collapse;padding-left:24px;padding-right:24px;padding-top:12px;padding-bottom:12px;background-color:#ffffff;\">
                        <br>
                        <div class=\"title\" style=\"font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:600;color:#374550;\">クレジットカードの有効期限変更のお願い。</div>
                        <br>
                        <div class=\"body-text\" style=\"font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:20px;text-align:left;color:#333333;\">
                            ";
        // line 21
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["Customer"]) || array_key_exists("Customer", $context) ? $context["Customer"] : (function () { throw new RuntimeError('Variable "Customer" does not exist.', 21, $this->source); })()), "name01", [], "any", false, false, true, 21), 21, $this->source), "html", null, true);
        echo " ";
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["Customer"]) || array_key_exists("Customer", $context) ? $context["Customer"] : (function () { throw new RuntimeError('Variable "Customer" does not exist.', 21, $this->source); })()), "name02", [], "any", false, false, true, 21), 21, $this->source), "html", null, true);
        echo " 様<br>
                            <br>
                            ";
        // line 23
        ...
        // line 24
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["expireDateTime"]) || array_key_exists("expireDateTime", $context) ? $context["expireDateTime"] : (function () { throw new RuntimeError('Variable "expireDateTime" does not exist.', 24, $this->source); })()), 24, $this->source), "Y/m/d"), "html", null, true);
        echo "となっております。<br/><br/>
                            クレジットカードの有効期限が切れますとクレジットカード決済が出来ない状態となりますので、<br><br/>
                            マイページでのクレジットカード情報の変更をお願いいたします。<br><br/>
                            <br/>
                            <br/>
                            クレジットカード情報を変更する場合、マイページログイン後、<br/>
                            下記URLにアクセスしてください。<br/>
                            ";
        // line 31
        ...
        // line 45
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["BaseInfo"]) || array_key_exists("BaseInfo", $context) ? $context["BaseInfo"] : (function () { throw new RuntimeError('Variable "BaseInfo" does not exist.', 45, $this->source); })()), "email02", [], "any", false, false, true, 45), 45, $this->source), "html", null, true);
        ...
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["BaseInfo"]) || array_key_exists("BaseInfo", $context) ? $context["BaseInfo"] : (function () { throw new RuntimeError('Variable "BaseInfo" does not exist.', 47, $this->source); })()), "shop_name", [], "any", false, false, true, 47), 47, $this->source), "html", null, true);
        echo "</a></div>
                        <div>copyright &copy; ";
        // line 48
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["BaseInfo"]) || array_key_exists("BaseInfo", $context) ? $context["BaseInfo"] : (function () { throw new RuntimeError('Variable "BaseInfo" does not exist.', 48, $this->source); })()), "shop_name", [], "any", false, false, true, 48), 48, $this->source), "html", null, true);
...
";
    ...
    {
        return "EccubePaymentLite42/Resource/template/default/Mail/expiration_notice_mail.html.twig";
    }
    ...
    {
        return array (  138 => 48,  132 => 47,  125 => 45,  121 => 44,  105 => 31,  95 => 24,  91 => 23,  84 => 21,  65 => 7,  57 => 1,);
    }
                ...
                <tr>
                    <td class=\"container-padding content\" align=\"left\" style=\"border-collapse:collapse;padding-left:24px;padding-right:24px;padding-top:12px;padding-bottom:12px;background-color:#ffffff;\">
                        ...
                        <div class=\"body-text\" style=\"font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:20px;text-align:left;color:#333333;\">
                            ...
                            お客様のご登録頂いておりますクレジットカードの有効期限が{{ expireDateTime|date('Y/m/d') }}となっております。<br/><br/>
                            クレジットカードの有効期限が切れますとクレジットカード決済が出来ない状態となりますので、<br><br/>
                            マイページでのクレジットカード情報の変更をお願いいたします。<br><br/>
                            <br/>
                            <br/>
...
", "EccubePaymentLite42/Resource/template/default/Mail/expiration_notice_mail.html.twig", "C:\\xampp\\htdocs\\ec-cube-dev\\app\\Plugin\\EccubePaymentLite42\\Resource\\template\\default\\Mail\\expiration_notice_mail.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array();
        static $filters = array("escape" => 7, "date" => 24);
