...
class __TwigTemplate_7a3719edf24177c48698a080be07c66e extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@admin/Product/csv_class_category.twig"));
...
";
    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        echo "</span>
                                        ";
        // line 81
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 81, $this->source); })()), "import_file", [], "any", false, false, true, 81), 81, $this->source), 'widget', ["attr" => ["accept" => "text/csv,text/tsv", "class" => "d-none"]]);
        echo "
                                        ";
        // line 82
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 82, $this->source); })()), "import_file", [], "any", false, false, true, 82), 82, $this->source), 'errors');
        echo "
                                    </div>
        ...
        echo "</span><i class=\"fa fa-question-circle fa-lg fa-lg ml-1\"></i></div>
                            ...
                            <div class=\"col-4 text-right\">
                                <a href=\"";
        // line 101
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("admin_product_csv_template", ["type" => "class_category"]);
...
";
    ...
    {
        return array (  350 => 122,  334 => 119,  328 => 117,  326 => 116,  322 => 114,  316 => 112,  314 => 111,  308 => 110,  305 => 109,  288 => 108,  276 => 101,  268 => 98,  256 => 88,  247 => 86,  243 => 85,  239 => 84,  234 => 82,  230 => 81,  226 => 80,  222 => 79,  217 => 77,  213 => 76,  208 => 74,  199 => 70,  192 => 65,  182 => 64,  128 => 21,  118 => 20,  99 => 16,  80 => 15,  69 => 11,  67 => 18,  65 => 13,  40 => 11,);
    }
    ...
    <div class=\"c-contentsArea__cols\">
        <div class=\"c-contentsArea__primaryCol\">
            <div class=\"c-primaryCol\">
                <div class=\"card rounded border-0 mb-4\">
                    <div class=\"card-header\">
                        <div class=\"d-inline-block\" data-tooltip=\"true\" data-placement=\"top\" title=\"{{ 'tooltip.class_category.csv_upload'|trans }}\"><span>{{ 'admin.common.csv_upload'|trans }}</span><i class=\"fa fa-question-circle fa-lg fa-lg ml-1\"></i></div>
                    </div>
                    <div id=\"ex-csv_category-upload\" class=\"card-body\">
                        <div class=\"row\">
                            <div class=\"col-2\"><span>{{ 'admin.common.csv_select'|trans }}</span></div>
                            <div class=\"col\">
                                <form id=\"upload-form\" method=\"post\" action=\"{{ url('admin_product_class_category_csv_import') }}\" enctype=\"multipart/form-data\">
...
{% endblock %}
", "@admin/Product/csv_class_category.twig", "C:\\xampp\\htdocs\\ec-cube-dev\\src\\Eccube\\Resource\\template\\admin\\Product\\csv_class_category.twig");
    }
