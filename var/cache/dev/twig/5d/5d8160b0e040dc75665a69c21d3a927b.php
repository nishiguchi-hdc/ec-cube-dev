...
class __TwigTemplate_f694019ba7134c6e80b95384f1934019 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
            ...
            if ((false == ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["child"], "vars", [], "any", false, false, true, 13), "label", [], "any", false, false, true, 13) == "admin.list.sort.key") || (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["child"], "vars", [], "any", false, false, true, 13), "label", [], "any", false, false, true, 13) == "admin.list.sort.type")))) {
                ...
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans((((twig_get_attribute($this->env, $this->source, ($context["custom_labels"] ?? null), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["child"], "vars", [], "any", false, false, true, 14), "name", [], "any", false, false, true, 14), [], "array", true, true, true, 14) &&  !(null === twig_get_attribute($this->env, $this->source, ($context["custom_labels"] ?? null), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["child"], "vars", [], "any", false, false, true, 14), "name", [], "any", false, false, true, 14), [], "array", false, false, true, 14)))) ? (twig_get_attribute($this->env, $this->source, ($context["custom_labels"] ?? null), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["child"], "vars", [], "any", false, false, true, 14), "name", [], "any", false, false, true, 14), [], "array", false, false, true, 14)) : (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["child"], "vars", [], "any", false, false, true, 14), "label", [], "any", false, false, true, 14)))), "html", null, true);
                echo ":&nbsp;</span>";
                // line 15
...
<ul class=\"list-inline\">
    {% for child in form.children|filter(child => (child.vars.name != '_token' and child.vars.data is not empty)) %}
        ...
        <li class=\"list-inline-item\"><span class=\"fw-bold\">{{ (custom_labels[child.vars.name] ?? child.vars.label)|trans }}:&nbsp;</span>
...
", "@admin/search_items.twig", "C:\\xampp\\htdocs\\ec-cube-dev\\app\\template\\admin\\search_items.twig");
    }
