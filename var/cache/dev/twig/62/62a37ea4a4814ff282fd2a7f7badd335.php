...
class __TwigTemplate_a51d78fbabf59e1c4f8d435d9e11272a extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@admin/Order/order_item_type.twig"));
...
<table class=\"table table-striped table-sm mb-3\">
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["OrderItemTypes"]) || array_key_exists("OrderItemTypes", $context) ? $context["OrderItemTypes"] : (function () { throw new RuntimeError('Variable "OrderItemTypes" does not exist.', 54, $this->source); })()));
...
";
    ...
    {
        return array (  147 => 67,  130 => 60,  125 => 58,  121 => 57,  115 => 55,  111 => 54,  102 => 48,  98 => 47,  65 => 17,  57 => 11,);
    }
...
<table class=\"table table-striped table-sm mb-3\">
    <thead class=\"table-active\">
    <tr>
        <th class=\"pt-2 pb-2 ps-3\">{{ 'admin.order.order_item_type'|trans }}</th>
        <th class=\"pt-2 pb-2 ps-3\">{{ 'admin.order.tax_type'|trans }}</th>
        <th class=\"pt-2 pb-2 pe-3\"></th>
    </tr>
    </thead>
    ...
    {% for OrderItemType in OrderItemTypes %}
        <form name=\"product_form{{ OrderItemType.OrderItemType.id }}\">
            <tr>
                <td class=\"align-middle ps-3\">{{ OrderItemType.OrderItemType.name }}</td>
                <td class=\"align-middle ps-3\">{{ OrderItemType.TaxType.name }}</td>
                <td class=\"align-middle pe-3 text-end\">
...
", "@admin/Order/order_item_type.twig", "C:\\xampp\\htdocs\\ec-cube-dev\\src\\Eccube\\Resource\\template\\admin\\Order\\order_item_type.twig");
    }
