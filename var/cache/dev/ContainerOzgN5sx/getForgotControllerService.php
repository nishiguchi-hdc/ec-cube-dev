...
class getForgotControllerService extends Eccube_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Eccube\\Controller\\ForgotController'] = $instance = new \Eccube\Controller\ForgotController(($container->privates['debug.validator'] ?? self::getDebug_ValidatorService($container)), ($container->privates['Eccube\\Service\\MailService'] ?? $container->load('getMailServiceService')), ($container->privates['Plugin\\B2BConnector\\Repository\\CustomerRepositoryDecorator'] ?? $container->load('getCustomerRepositoryDecoratorService')), ($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService')));
