...
class Eccube_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Plugin\\B2BConnector\\Event\\AdminOrderShippingSubscriber' => 'getAdminOrderShippingSubscriberService',
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('admin.customer.delivery.edit.index.initialize', [#[\Closure(name: 'Plugin\\B2BConnector\\Event\\AdminCustomerAddressSubscriber')] fn () => ($container->services['Plugin\\B2BConnector\\Event\\AdminCustomerAddressSubscriber'] ?? $container->load('getAdminCustomerAddressSubscriberService')), 'onInitialize'], 0);
        $instance->addListener('admin.customer.delivery.edit.index.complete', [#[\Closure(name: 'Plugin\\B2BConnector\\Event\\AdminCustomerAddressSubscriber')] fn () => ($container->services['Plugin\\B2BConnector\\Event\\AdminCustomerAddressSubscriber'] ?? $container->load('getAdminCustomerAddressSubscriberService')), 'onComplete'], 0);
        $instance->addListener('admin.customer.edit.index.initialize', [#[\Closure(name: 'Plugin\\B2BConnector\\Event\\AdminCustomerSubscriber')] fn () => ($container->services['Plugin\\B2BConnector\\Event\\AdminCustomerSubscriber'] ?? $container->load('getAdminCustomerSubscriberService')), 'onInitialize'], 0);
        $instance->addListener('admin.customer.edit.index.complete', [#[\Closure(name: 'Plugin\\B2BConnector\\Event\\AdminCustomerSubscriber')] fn () => ($container->services['Plugin\\B2BConnector\\Event\\AdminCustomerSubscriber'] ?? $container->load('getAdminCustomerSubscriberService')), 'onComplete'], 0);
        $instance->addListener('admin.order.edit.index.initialize', [#[\Closure(name: 'Plugin\\B2BConnector\\Event\\AdminOrderShippingSubscriber')] fn () => ($container->services['Plugin\\B2BConnector\\Event\\AdminOrderShippingSubscriber'] ?? $container->load('getAdminOrderShippingSubscriberService')), 'onInitialize'], 0);
        $instance->addListener('admin.order.edit.index.complete', [#[\Closure(name: 'Plugin\\B2BConnector\\Event\\AdminOrderShippingSubscriber')] fn () => ($container->services['Plugin\\B2BConnector\\Event\\AdminOrderShippingSubscriber'] ?? $container->load('getAdminOrderShippingSubscriberService')), 'onComplete'], 0);
        $instance->addListener('admin.product.edit.initialize', [#[\Closure(name: 'Plugin\\B2BConnector\\Event\\AdminProductSubscriber')] fn () => ($container->services['Plugin\\B2BConnector\\Event\\AdminProductSubscriber'] ?? $container->load('getAdminProductSubscriberService')), 'onProductEditInitialize'], 0);
