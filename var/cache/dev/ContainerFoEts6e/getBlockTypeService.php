...
class getBlockTypeService extends Eccube_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['Eccube\\Form\\Type\\Admin\\BlockType'])) {
            return $container->privates['Eccube\\Form\\Type\\Admin\\BlockType'];
        }

        return $container->privates['Eccube\\Form\\Type\\Admin\\BlockType'] = new \Eccube\Form\Type\Admin\BlockType($a, ($container->services['Eccube\\Common\\EccubeConfig'] ?? self::getEccubeConfigService($container)));
    }
}
