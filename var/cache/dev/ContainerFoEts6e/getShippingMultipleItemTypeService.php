...
class getShippingMultipleItemTypeService extends Eccube_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['Eccube\\Form\\Type\\ShippingMultipleItemType'])) {
            return $container->privates['Eccube\\Form\\Type\\ShippingMultipleItemType'];
        }
        ...
        $c = ($container->privates['Eccube\\Service\\OrderHelper'] ?? $container->load('getOrderHelperService'));

        if (isset($container->privates['Eccube\\Form\\Type\\ShippingMultipleItemType'])) {
            return $container->privates['Eccube\\Form\\Type\\ShippingMultipleItemType'];
        }

        return $container->privates['Eccube\\Form\\Type\\ShippingMultipleItemType'] = new \Eccube\Form\Type\ShippingMultipleItemType(($container->services['Eccube\\Common\\EccubeConfig'] ?? self::getEccubeConfigService($container)), ($container->privates['Eccube\\Session\\Session'] ?? self::getSessionService($container)), $a, ($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), ($container->privates['Eccube\\Repository\\Master\\PrefRepository'] ?? $container->load('getPrefRepositoryService')), $b, $c);
    }
}
